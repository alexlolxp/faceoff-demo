...
class TitleState extends MusicBeatState
{
	...
	var futuristicLogoSpr:FlxSprite;
	...
	function startIntro()
	{
		...
		var frontbg:FlxSprite = new FlxSprite().loadGraphic(Paths.image('menu/frontbg'));
		frontbg.antialiasing = ClientPrefs.globalAntialiasing;
		frontbg.setGraphicSize(FlxG.width, FlxG.height);
		frontbg.screenCenter();
		frontbg.updateHitbox();
		add(frontbg);

		logoBl = new FlxSprite(600, 30);
		...
		var theBois:FlxSprite = new FlxSprite(0, 0);
		theBois.frames = Paths.getSparrowAtlas('menu/title_screen_stuff');
		theBois.antialiasing = ClientPrefs.globalAntialiasing;
		theBois.animation.addByPrefix('idle', 'title screen stuff idle', 24);
		...
		futuristicLogoSpr = new FlxSprite(0, FlxG.height * 0.4).loadGraphic(Paths.image('funkylogo'));
		add(futuristicLogoSpr);
		futuristicLogoSpr.visible = false;
		futuristicLogoSpr.setGraphicSize(Std.int(futuristicLogoSpr.width * 0.55));
		futuristicLogoSpr.updateHitbox();
		futuristicLogoSpr.screenCenter(X);
		futuristicLogoSpr.antialiasing = ClientPrefs.globalAntialiasing;
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			switch (curBeat)
			{
				...
				case 3:
					addMoreText('Team Funky', -60);
					futuristicLogoSpr.visible = true;
				// credTextShit.text += '\npresent...';
				...
				// credTextShit.screenCenter();
				case 5:
					createCoolText(['futuristic version'], -60);
				case 7:
					addMoreText('of this funky shit', -60);
				...
				// credTextShit.screenCenter();
				case 13:
					addMoreText('Futuristic');
				// credTextShit.visible = true;
				case 14:
					addMoreText('Face-Off');
				// credTextShit.text += '\nNight';
				case 15:
					addMoreText('Bitch'); // credTextShit.text += '\nFunkin';
