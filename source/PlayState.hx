...
class PlayState extends MusicBeatState
{
	...
	private var forcedScrollSpeed:Bool = false;
	#if (haxe >= "4.0.0")
	...
	override public function create()
	{
		...
		timeBar.createFilledBar(0xFF000000, 0xFF10B7E5);
	...
	function ajaxHover()
	{
		ajaxHovering = !ajaxHovering;

		if (ajaxHovering)
		{
				FlxTween.tween(dad, {y: dad.y - 50}, 2, {
					ease: FlxEase.quadInOut,
	...
	override public function update(elapsed:Float)
	{
		...
		if (SONG.player2 == 'xeno' && healthBar.percent > 80)
			{
			healthBar.createFilledBar(FlxColor.fromRGB(182, 1, 72),
				FlxColor.fromRGB(boyfriend.healthColorArray[0], boyfriend.healthColorArray[1], boyfriend.healthColorArray[2]));
			healthBar.updateBar();
			}
		else
	...
	public function triggerEventNote(eventName:String, value1:String, value2:String) 
	{
		switch(eventName) {
			...
			case 'Scroll Speed Change':
				...
				forcedScrollSpeed = false;
				if(!Math.isNaN(Std.parseFloat(value1)) || !Math.isNaN(Std.parseFloat(value2))) 
				{
					SONG.speed = val1;
					forcedScrollSpeed = true;
				}
		}
